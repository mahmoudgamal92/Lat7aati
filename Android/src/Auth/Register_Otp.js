import {Animated, Image, SafeAreaView, Text, View,StyleSheet} from 'react-native';
...
const Register_Otp = ({route,navigation}) => {
  ...
  const VerifyCode = () => {
    fetch("https://lat7aati.com/api/verify_code", {
      method: "POST",
      headers: {
